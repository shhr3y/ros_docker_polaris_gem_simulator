...
set(MSG_I_FLAGS "-Ijsk_topic_tools:/root/simulator/src/ros_drivers/jsk_rviz/jsk_topic_tools/msg")
...
get_filename_component(_filename "/root/simulator/src/ros_drivers/jsk_rviz/jsk_topic_tools/srv/Update.srv" NAME_WE)
add_custom_target(_jsk_topic_tools_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "jsk_topic_tools" "/root/simulator/src/ros_drivers/jsk_rviz/jsk_topic_tools/srv/Update.srv" ""
)

get_filename_component(_filename "/root/simulator/src/ros_drivers/jsk_rviz/jsk_topic_tools/srv/PassthroughDuration.srv" NAME_WE)
add_custom_target(_jsk_topic_tools_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "jsk_topic_tools" "/root/simulator/src/ros_drivers/jsk_rviz/jsk_topic_tools/srv/PassthroughDuration.srv" ""
)

get_filename_component(_filename "/root/simulator/src/ros_drivers/jsk_rviz/jsk_topic_tools/msg/TopicInfo.msg" NAME_WE)
add_custom_target(_jsk_topic_tools_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "jsk_topic_tools" "/root/simulator/src/ros_drivers/jsk_rviz/jsk_topic_tools/msg/TopicInfo.msg" ""
)

get_filename_component(_filename "/root/simulator/src/ros_drivers/jsk_rviz/jsk_topic_tools/srv/ChangeTopic.srv" NAME_WE)
add_custom_target(_jsk_topic_tools_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "jsk_topic_tools" "/root/simulator/src/ros_drivers/jsk_rviz/jsk_topic_tools/srv/ChangeTopic.srv" ""
)

get_filename_component(_filename "/root/simulator/src/ros_drivers/jsk_rviz/jsk_topic_tools/srv/List.srv" NAME_WE)
add_custom_target(_jsk_topic_tools_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "jsk_topic_tools" "/root/simulator/src/ros_drivers/jsk_rviz/jsk_topic_tools/srv/List.srv" ""
)
...
_generate_msg_cpp(jsk_topic_tools
  "/root/simulator/src/ros_drivers/jsk_rviz/jsk_topic_tools/msg/TopicInfo.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/jsk_topic_tools)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/jsk_topic_tools\")")
  # install generated code
  install(
