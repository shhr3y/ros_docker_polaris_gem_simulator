...
if("TRUE" STREQUAL "TRUE")
  set(sicktoolbox_wrapper_SOURCE_PREFIX /root/simulator/src/ros_drivers/sicktoolbox_wrapper)
  set(sicktoolbox_wrapper_DEVEL_PREFIX /root/simulator/devel)
  ...
  set(sicktoolbox_wrapper_INSTALL_PREFIX /root/simulator/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'sicktoolbox_wrapper' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/simulator/src/ros_drivers/sicktoolbox_wrapper/${idir}'.  ${_report}")
    endif()
